		...
		<div class="card custom-card service">
			<div class="card-body">
				<div class="item-box text-center">
					<div class=" text-center mb-2 text-primary"><i class="	fa fa-file-o"></i>
					</div>
					<div class="item-box-wrap">						
						<h5 class="mb-2">
							<a href="/khoahoc/khoa-hoc?menu=khoahoc">Quản lý đơn hàng</a>
						</h5>						
	...
	<div class="col-sm-12">
        <div class="card custom-card">
        	<div class="card-body" style="width: 100%; height:450px">
        		<img src="/libs/images/BeTong.jpg" alt="img" style="width: 100%; height: 100%; object-fit: cover;">
        	</div>
        </div>
    </div>
</div>
