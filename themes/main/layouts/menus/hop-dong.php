<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<span class="side-menu__label"><i class="fa fa-folder-o"></i> Quản lý hợp đồng</span><i class="angle fa fa-caret-right"></i>
	</a>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="side7">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/user/user-ajax?menu=hd1') ?>" class="slide-item" data-menu="hd1"><i class="fe fe-file-text"></i> Danh sách hợp đồng</a>
							</li>
						</ul>
