<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<span class="side-menu__label"><i class="fa fa-folder-o"></i> Quản lý đơn hàng</span><i class="angle fa fa-caret-right"></i>
	</a>
	<ul class="slide-menu" data-menu="dh">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="side7">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/donhang/don-hang?menu=dh1') ?>" class="slide-item" data-menu="dh1"><i class="fe fe-file-text"></i> Quản lý đơn hàng</a>
							</li>
						</ul>
