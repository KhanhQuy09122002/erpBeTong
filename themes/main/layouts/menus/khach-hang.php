<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<span class="side-menu__label"><i class="fa fa-folder-o"></i> Danh mục khách hàng</span><i class="angle fa fa-caret-right"></i>
	</a>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="side7">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/user/user-ajax?menu=kh1') ?>" class="slide-item" data-menu="kh1"><i class="fe fe-file-text"></i> Danh sách khách hàng</a>
							</li>
						</ul>
